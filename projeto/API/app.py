...
from projeto.API.schemas.uf_schema import apresenta_lista_uf
from schemas import *
...
@app.get('/uf',tags=[uf_tag],
        responses={"200": UfViewSchema,"404": ErrorSchema})
def get_Uf():
    """Consulta as UF 
    ...
    try:
        ...
        session = Session()
        # fazendo a busca
        lista = session.query(Uf).order_by(Uf.ds_uf.asc()).all()
